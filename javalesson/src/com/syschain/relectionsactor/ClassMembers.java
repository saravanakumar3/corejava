...
import com.syschain.relectionsactor.Actor.Emp;
...
{
	/*  {
          Class<?> classreflected= ob.getClass();//?- template(any type)
          //<?> - it used for metadata about the object
...
actorReference.city="Chennai"; actorReference.printCity();
...
public static void testsetAccessible() {
	try {
		String cname = "com.syschain.relectionsactor.Actor";
